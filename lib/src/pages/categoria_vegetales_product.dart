...
class CategoriaVerduras extends StatefulWidget{
  const CategoriaVerduras({Key? key}) : super(key: key);
   @override
  _CategoriaVerdurasState  createState() => _CategoriaVerdurasState ();
}
class _CategoriaVerdurasState extends State<CategoriaVerduras>{
  ...
  void initState() {
    super.initState();
    mList1 = productsImageListVerduras();
    mList2 = productsNameListVerduras();
    mList3 = productsPricesListVerduras();
